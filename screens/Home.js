...
const Home=({navigation})=>{
   ...
   function renderHeader(){
         return(
                <View style={{flexDirection:'row',height:50,flex:1,paddingHorizontal:SIZES.padding,alignItems:'center'}}>
                <View style={{flex:1}}>
                     <View>
                        <Text style={{...FONTS.h3,color:COLORS.white,fontWeight:"700"}}>Good Morning</Text>
                        <Text style={{...FONTS.h2,color:COLORS.white,fontWeight:"700"}}>{profile.name}</Text>
                     </View>
                </View>
                <TouchableOpacity 
                style={{
                    ...
                    justifyContent:'center',borderRadius:25,backgroundColor:'rgba(0,0,0,0.5)'}}>
                    ...
                    FONTS.body3}}>{profile.point} point</Text>
                    </View>
                </TouchableOpacity>
   ...
   function renderButtonSection(){
    return(
        <View style={{flex:1,justifyContent:"center",flexDirection:'row',padding:SIZES.padding}}>
       <View style={{flexDirection:'row',padding:12,height:70,backgroundColor:COLORS.secondary,borderRadius:SIZES.radius}}>
         {/*Claim*/}
         <TouchableOpacity 
         style={{flex:1}}
...
<Text style={{marginLeft:SIZES.base,...FONTS.body3,color:COLORS.white}}>Claim</Text>
        ...
        <Text style={{marginLeft:SIZES.base, ...FONTS.body3,color:COLORS.white}}>Get Point</Text>
         ...
         onPress={()=>console.log("My Card")}>
            ...
            />
            <Text style={{
                marginLeft:SIZES.base,...FONTS.body3,color:COLORS.white
...
/>
<Text style={{
    marginLeft:5,...FONTS.body3,color:COLORS.lightGray
}}>
{item.lastRead}
...
marginLeft:5, ...FONTS.body3,color:COLORS.lightGray
    ...
    return(
        <View style={{flex:1}}>
            ...
            <Text style={{...FONTS.h2,color:COLORS.white,fontWeight:700}}>My Book</Text>
             <TouchableOpacity onPress={()=>console.log("See More")}>
              <Text style={{...FONTS.body3, color:COLORS.lightGray,alignSelf:'flex-start',
                 ...
                 <View style={{flexDirection:'row',marginTop:SIZES.base}}>
                  {
                    ...
                    <View style={{
                        ...
                        <Text style={{
                            ...FONTS.body3,color:COLORS.lightGreen
                        }}>
                            Adventure
                        </Text>
                    </View>
                  }
                  {
                    ...
                    <View style={{
                        ...
                        <Text style={{
                            ...FONTS.body3,color:COLORS.lightRed
                        }}>
                            Romance
                        </Text>
                    </View>
